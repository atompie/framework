...
namespace AtomPie\Web {
    ...
    class Browser
    {
        ...
        const CONTEXT = '__Browser__';

        const PC = 1;
        const MOBILE = 2;

        private static $bIsMobile;

        private static function getMobileInfo()
        {

            // TODO repair
            // TODO Use mobiledetect/mobiledetectlib
        ...
        {
            if (!isset(self::$bIsMobile)) {
                self::$bIsMobile = self::getMobileInfo();
            }
